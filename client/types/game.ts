// 阵营枚举
export enum Faction {
  ENGLAND = 'ENGLAND',           // 英格兰：长弓手优势、城堡防御
  FRANCE = 'FRANCE',             // 法兰西：重骑兵冲锋、骑士精神
  HOLY_ROMAN_EMPIRE = 'HRE',     // 神圣罗马帝国：步兵方阵、帝国权威
  VIKING = 'VIKING',             // 维京：狂战士、掠夺机制
  BYZANTIUM = 'BYZANTIUM',       // 拜占庭：希腊火、防御工事
}
...
export enum TacticType {
  INSTANT = 'INSTANT',           // 即时战术
  ONGOING = 'ONGOING',           // 持续效果
  EQUIPMENT = 'EQUIPMENT',       // 装备卡
}

// 建筑卡类型枚举
export enum BuildingType {
  ECONOMIC = 'ECONOMIC',         // 经济建筑
  MILITARY = 'MILITARY',         // 军事建筑
...
export interface Card {
  ...
  type: CardType;
  faction: Faction;
  cost: number;                  // 黄金消耗（单位/建筑）或影响力消耗（战术）
  description: string;
  flavorText?: string;
  imageUrl?: string;
}
