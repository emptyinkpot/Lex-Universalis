...
@export var status_effect_script_path: String = "res://core/status_effects/BaseStatusEffect.gd"	# script of the BaseStatusEffect determining behavior of the status
